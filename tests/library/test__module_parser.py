...
class Test_PythonFileVisitor(TestCase):
    ...
    def test_UC4_pyi_type_hints_ex1_in_functions(self):
        expected = [
            ["num: <class 'str'>", "my_list: typing.List", "my_bool: <class 'bool'>",
    ...
    def test_UC4_pyi_type_hints_ex2_in_functions(self):
        expected = [
            ["arg0: typing.Callable[[typing.Tuple[int, Exception, typing.Any], typing.Any], int]",
             "arg1: typing.Tuple[int, torch.Tensor]",
             "arg2: typing.Tuple[typing.List[typing.Callable[[int], float]], str, float, typing.Any]"
             ],
            ["arg0: typing.Callable[..., typing.Any]",
             "arg1: typing.Callable[[typing.Tuple[int, Exception, typing.Any]], NoneType]",
             "arg2"]
        ]
